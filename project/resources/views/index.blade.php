    ...
    <body class="antialiased">
      ...
      <div class=" px-6 py-4 ">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2">
                        ...
                        <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-l">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 text-lg leading-7 font-semibold text-gray-900 dark:text-white">Cloud Uploads</div>
                            </div>

                            <div class="ml-12">
                                <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                      You can upload file via our cloud api
                                  </div>

                                  <form  enctype="multipart/form-data" action="/api/v1/image-uploads/via/cloud" method="post" >
                                        {{ csrf_field() }}

                                        <label for="Product Name">Upload pictures to cloud:</label>
                                        <br />
        ...
        <script>
              ...
              const apikey ='9592284-ac011e65dcf94b111588bba1b';
